...
Group.new('TSConstant',           colors.purple, colors.none, no)
...
-- Group.new('TSFuncBuiltin',        colors.hue_2, colors.none, no)
-- Group.new('TSFuncMacro',          colors.hue_6_2, colors.none, no)
Group.new('TSInclude',            colors.cyan, colors.none, no)
...
Group.new('TSNamespace',          colors.aqua, colors.none, no)
...
Group.new('TSProperty',           colors.seagreen, colors.none, no)
...
Group.new('TSVariable',           colors.white, colors.none, no)
